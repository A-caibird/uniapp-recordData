<template>
	<view class="yao-order-wrap">
		<view class="order-info" @tap="$u.throttle(tapGoDetail(info))">
			<view class="club-name-label-wrap">
			...
			<view class="seat-amount-wrap">
				<view class="seat">
					...
					<text class="text2">{{info.tableSn}}</text>
				</view>
				<view class="amount">
					<text class="text1">金额：</text>
					<text class="text2">{{info.amount}}</text>
				</view>
			</view>
			<view class="date">
